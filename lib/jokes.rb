class Jokes
  ...
  def initial_joke
    return 'ooh, you are the programmer right? Do you remember the day you got stuck in the bathroom because the instruction on the soap cover said: Lather, Rinse, Repeat'
  end
end
